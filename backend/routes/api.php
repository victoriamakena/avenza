...
// Email Verification (public — link clicked from inbox, secured by signature only)
    Route::get('/auth/email/verify/{id}/{hash}', [EmailVerificationController::class,'verify'
    ])->middleware(['signed', 'throttle:6,1'])
    ->name('verification.verify');

// Authenticated Routes (logged in, not necessarily verified)
...
Route::prefix('admin')
    ...
    ->group(function () {
        ...
        Route::get('/redemptions', [RedemptionManagementController::class, 'index']);
